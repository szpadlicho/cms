...
--
-- Host: 127.0.0.1
-- Generation Time: 15 Gru 2014, 15:01
...
CREATE TABLE IF NOT EXISTS `product_tab` (
  ...
  `predefined_d` varchar(30) DEFAULT NULL,
...
--
-- Struktura tabeli dla tabeli `shipping_poczta_polska_s.a.`
--

CREATE TABLE IF NOT EXISTS `shipping_poczta_polska_s.a.` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) DEFAULT NULL,
  `name_d` varchar(30) DEFAULT NULL,
...
--
-- Zrzut danych tabeli `shipping_poczta_polska_s.a.`
--

INSERT INTO `shipping_poczta_polska_s.a.` (`id`, `name`, `name_d`, `configuration_mod`, `weight_of`, `weight_to`, `price_of`, `price_to`, `package_share`, `max_item_in_package`, `allow_prepayment`, `price_prepayment`, `allow_ondelivery`, `price_ondelivery`, `free_of`, `mod`) VALUES
(1, 'poczta_polska_s.a.', 'poczta_polska_s.a.', 'price', '', '', '1', '100', 'no', '10', '', '19,99', 'yes', '24,99', '', 0);

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `shipping_siodemka`
--

CREATE TABLE IF NOT EXISTS `shipping_siodemka` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) DEFAULT NULL,
  `name_d` varchar(30) DEFAULT NULL,
  `configuration_mod` varchar(20) DEFAULT NULL,
...
--
-- Zrzut danych tabeli `shipping_siodemka`
--

INSERT INTO `shipping_siodemka` (`id`, `name`, `name_d`, `configuration_mod`, `weight_of`, `weight_to`, `price_of`, `price_to`, `package_share`, `max_item_in_package`, `allow_prepayment`, `price_prepayment`, `allow_ondelivery`, `price_ondelivery`, `free_of`, `mod`) VALUES
(1, 'siodemka', 'siodemka', 'weight', '5', '10', '', '', 'no', '10', '', '5', 'yes', '10', '100', 0),
(2, 'siodemka', 'siodemka', 'weight', '11', '20', '', '', 'no', '10', '', '11', 'yes', '20', '', 0);

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `shipping_supplier`
--

CREATE TABLE IF NOT EXISTS `shipping_supplier` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Zrzut danych tabeli `shipping_supplier`
--

INSERT INTO `shipping_supplier` (`id`, `supplier_name`, `supplier_name_d`, `mod`) VALUES
(1, 'siodemka', 'siódemka', NULL),
(2, 'trody_tezzocx', 'TródY TężźóćX', NULL),
(3, 'poczta_polska_s.a.', 'Poczta Polska S.A.', NULL);

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `shipping_trody_tezzocx`
--

CREATE TABLE IF NOT EXISTS `shipping_trody_tezzocx` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) DEFAULT NULL,
  `name_d` varchar(30) DEFAULT NULL,
  `configuration_mod` varchar(20) DEFAULT NULL,
...
--
-- Zrzut danych tabeli `shipping_trody_tezzocx`
--

INSERT INTO `shipping_trody_tezzocx` (`id`, `name`, `name_d`, `configuration_mod`, `weight_of`, `weight_to`, `price_of`, `price_to`, `package_share`, `max_item_in_package`, `allow_prepayment`, `price_prepayment`, `allow_ondelivery`, `price_ondelivery`, `free_of`, `mod`) VALUES
(1, 'trody_tezzocx', 'trody_tezzocx', 'simple', '', '', '', '', 'yes', '', '', '15', 'yes', '20', '', 0);
